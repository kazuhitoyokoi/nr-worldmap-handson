...
ご自身のスマホで試したい場合は、[位置情報送信機能付きIoT PhoneアプリのURL](https://kazuhitoyokoi.github.io/iot-phone/)にアクセスして、トピック名として一意の名前(nodered451など)を入力して、位置情報データを送信することもできます。ただし、インターネット上に位置情報が公開されてしまうため、ご自宅などではアクセスしないようにしてください。
